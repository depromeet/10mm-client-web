const tokens = {
  ...
  "colors.purple.purple200": {
    "value": "#C5C4FC",
    "variable": "var(--colors-purple-purple200)"
  },
  ...
  "colors.colorPalette.purple200": {
    "value": "var(--colors-color-palette-purple200)",
    "variable": "var(--colors-color-palette-purple200)"
  },
